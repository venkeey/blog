#!/usr/bin/env python3
"""
Flask server for the Comprehensive Vedic Astrology Calculator
"""
    ...
    <script>
        ...
        function displayResults(data) {
            ...
            let html = `
                ...
                <div class="chart-section">
                    ...
                    <button class="download-btn" onclick="downloadJSON(data)">Download Complete Data (JSON)</button>
                    <button class="download-btn" onclick="copyToClipboard(data)" style="margin-top: 10px; background: #17a2b8;">Copy JSON to Clipboard</button>
                </div>
        ...
        function downloadJSON(data) {
            try {
                ...
                link.href = url;
                link.download = 'astrological_charts.json';
        ...
        function copyToClipboard(data) {
            try {
                ...
                navigator.clipboard.writeText(dataStr).then(function() {
                    alert('JSON data copied to clipboard! You can now paste it into a text file.');
                }).catch(function(err) {
...
def health():
    ...
    return jsonify({'status': 'healthy', 'message': 'Astrology calculator is running'})

if __name__ == '__main__':
    print("🌟 Starting Comprehensive Vedic Astrology Calculator Server")
    print("=" * 60)
